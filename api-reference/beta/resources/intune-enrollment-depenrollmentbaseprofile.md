...
|supervisedModeEnabled|Boolean|Supervised mode, True to enable, false otherwise. See https://docs.microsoft.com/mem/intune/enrollment/ for additional information.|
