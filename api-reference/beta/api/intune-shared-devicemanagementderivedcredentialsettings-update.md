...
Update the properties of a [deviceManagementDerivedCredentialSettings](/mem/intune/configuration/shared-user-device-settings-windows) object.
...
|issuer|[deviceManagementDerivedCredentialIssuer](/mem/intune/configuration/shared-user-device-settings-windows))|The derived credential provider to use. Possible values are: `intercede`, `entrustDatacard`, `purebred`.|
|notificationType|[deviceManagementDerivedCredentialNotificationType](/mem/intune/configuration/shared-user-device-settings-windows))|The methods used to inform the end user to open Company Portal to deliver Wi-Fi, VPN, or email profiles that use certificates to the device. Possible values are: `none`, `companyPortal`, `email`.|
