...
Update the properties of a [windowsUpdateState](/mem/intune/protect/windows-10-feature-updates) object.
...
|status|[windowsUpdateStatus](/mem/intune/protect/windows-10-feature-updates)|Windows udpate status. Possible values are: `upToDate`, `pendingInstallation`, `pendingReboot`, `failed`.|
